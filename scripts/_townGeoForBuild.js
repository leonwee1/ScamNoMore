/**
 * Town coordinates for buildSingaporeGeo.js.
 *
 * Mirrors TOWN_GEO in src/data/townGeo.ts. Kept as plain JS so the build script
 * can require it without a TypeScript step; the two must stay in sync.
 */
const TOWN_GEO = {
