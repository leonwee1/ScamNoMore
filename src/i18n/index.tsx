...
const en = {
  ...
  'chatbot.name': 'Hans',
  'chatbot.title': 'Ask Hans',
  'chatbot.greeting':
    'Hi! I’m Hans, the ScamNoMore assistant. Ask me anything about scams, or describe a message/call and I’ll help you spot red flags.',
  'chatbot.placeholder': 'Ask about a scam…',
  'chatbot.send': 'Send',
  'chatbot.commonQuestions': 'Common questions',
  'chatbot.promptScam': 'Is this a scam?',
  'chatbot.promptMessage': 'How do I check a suspicious message?',
  'chatbot.promptPaid': 'What if I sent money?',
  'chatbot.promptReport': 'How do I report a scam?',
  ...
  'analyze.privacy.beforeContinue': 'Before you continue:',
  'analyze.privacy.bodyPoint1': 'Your file is sent securely for checking.',
  'analyze.privacy.bodyPoint2': 'It may be checked by ScamNoMore and OpenAI.',
  'analyze.privacy.bodyPoint3': 'We do not intentionally keep your file after checking.',
  'analyze.privacy.warningTitle': 'Protect your privacy:',
  'analyze.privacy.imageWarningPoint1': 'Crop out OTPs, NRIC numbers, passwords, Singpass details and card numbers.',
  'analyze.privacy.imageWarningPoint2': 'Do not upload media with private information.',
  'analyze.privacy.audioVideoWarningPoint1': 'Do not upload OTPs, NRIC numbers, passwords, Singpass details or card numbers.',
  'analyze.privacy.audioVideoWarningPoint2': 'Use a version with private information removed.',
  ...
  'report.comfort': 'Seen or experienced a suspected scam?',
  'report.supporting': 'Your report helps warn others.',
  ...
  'community.participant': 'Participant {id}',
...
const zh: Dict = {
  ...
  'chatbot.name': 'Hans',
  'chatbot.title': '询问 Hans',
  'chatbot.greeting':
    '您好！我是 Hans，ScamNoMore 助手。您可以询问任何关于诈骗的问题，或描述信息／来电，我会帮您识别可疑之处。',
  'chatbot.placeholder': '询问关于诈骗的问题…',
  'chatbot.send': '发送',
  'chatbot.commonQuestions': '常见问题',
  'chatbot.promptScam': '这是骗局吗？',
  'chatbot.promptMessage': '如何检查可疑信息？',
  'chatbot.promptPaid': '如果我已经汇款怎么办？',
  'chatbot.promptReport': '如何举报诈骗？',
  ...
  'analyze.privacy.beforeContinue': '继续前请注意：',
  'analyze.privacy.bodyPoint1': '您的文件会安全发送以进行检查。',
  'analyze.privacy.bodyPoint2': 'ScamNoMore 和 OpenAI 可能会检查文件。',
  'analyze.privacy.bodyPoint3': '我们不会在检查后主动保留您的文件。',
  'analyze.privacy.warningTitle': '保护您的隐私：',
  'analyze.privacy.imageWarningPoint1': '请裁剪掉 OTP、身份证号码、密码、Singpass 资料和卡号。',
  'analyze.privacy.imageWarningPoint2': '请勿上传含有个人资料的媒体。',
  'analyze.privacy.audioVideoWarningPoint1': '请勿上传含有 OTP、身份证号码、密码、Singpass 资料或卡号的文件。',
  'analyze.privacy.audioVideoWarningPoint2': '请使用已删除个人资料的版本。',
  'analyze.privacy.body':
  ...
  'report.comfort': '看见或经历了疑似诈骗？',
  'report.supporting': '您的举报能提醒他人。',
...
const ms: Dict = {
  ...
  'chatbot.name': 'Hans',
  'chatbot.title': 'Tanya Hans',
  'chatbot.greeting':
    'Hai! Saya Hans, pembantu ScamNoMore. Tanya apa sahaja tentang penipuan, atau terangkan mesej/panggilan dan saya akan bantu anda mengenal pasti tanda bahaya.',
  'chatbot.placeholder': 'Tanya tentang penipuan…',
  'chatbot.send': 'Hantar',
  'chatbot.commonQuestions': 'Soalan biasa',
  'chatbot.promptScam': 'Adakah ini penipuan?',
  'chatbot.promptMessage': 'Bagaimana saya semak mesej mencurigakan?',
  'chatbot.promptPaid': 'Apa perlu dibuat jika saya sudah hantar wang?',
  'chatbot.promptReport': 'Bagaimana hendak melaporkan penipuan?',
  ...
  'analyze.privacy.beforeContinue': 'Sebelum meneruskan:',
  'analyze.privacy.bodyPoint1': 'Fail anda dihantar dengan selamat untuk diperiksa.',
  'analyze.privacy.bodyPoint2': 'ScamNoMore dan OpenAI mungkin memeriksa fail ini.',
  'analyze.privacy.bodyPoint3': 'Kami tidak sengaja menyimpan fail anda selepas pemeriksaan.',
  'analyze.privacy.warningTitle': 'Lindungi privasi anda:',
  'analyze.privacy.imageWarningPoint1': 'Potong OTP, nombor NRIC, kata laluan, butiran Singpass dan nombor kad.',
  'analyze.privacy.imageWarningPoint2': 'Jangan muat naik media yang mengandungi maklumat peribadi.',
  'analyze.privacy.audioVideoWarningPoint1': 'Jangan muat naik OTP, nombor NRIC, kata laluan, butiran Singpass atau nombor kad.',
  'analyze.privacy.audioVideoWarningPoint2': 'Gunakan versi yang telah membuang maklumat peribadi.',
  'analyze.privacy.body':
  ...
  'report.comfort': 'Pernah lihat atau alami penipuan?',
  'report.supporting': 'Laporan anda membantu memberi amaran.',
  ...
  'community.participant': 'Peserta {id}',
...
const ta: Dict = {
  ...
  'chatbot.name': 'Hans',
  'chatbot.title': 'Hans-ஐ கேளுங்கள்',
  'chatbot.greeting':
    'வணக்கம்! நான் Hans, ScamNoMore உதவியாளர். மோசடிகள் பற்றி எதையும் கேளுங்கள், அல்லது செய்தி／அழைப்பை விவரியுங்கள் — எச்சரிக்கை அறிகுறிகளை கண்டறிய உதவுவேன்.',
  'chatbot.placeholder': 'மோசடி பற்றி கேளுங்கள்…',
  'chatbot.send': 'அனுப்பு',
  'chatbot.commonQuestions': 'பொதுவான கேள்விகள்',
  'chatbot.promptScam': 'இது மோசடியா?',
  'chatbot.promptMessage': 'சந்தேகமான செய்தியை எப்படிச் சரிபார்ப்பது?',
  'chatbot.promptPaid': 'பணம் அனுப்பிவிட்டால் என்ன செய்வது?',
  'chatbot.promptReport': 'மோசடியை எப்படிப் புகாரளிப்பது?',
  ...
  'analyze.privacy.beforeContinue': 'தொடர்வதற்கு முன்:',
  'analyze.privacy.bodyPoint1': 'உங்கள் கோப்பு பாதுகாப்பாகச் சரிபார்ப்புக்காக அனுப்பப்படும்.',
  'analyze.privacy.bodyPoint2': 'ScamNoMore மற்றும் OpenAI கோப்பைச் சரிபார்க்கலாம்.',
  'analyze.privacy.bodyPoint3': 'சரிபார்த்த பிறகு உங்கள் கோப்பை நாங்கள் வேண்டுமென்றே சேமிக்கமாட்டோம்.',
  'analyze.privacy.warningTitle': 'உங்கள் தனியுரிமையைப் பாதுகாக்கவும்:',
  'analyze.privacy.imageWarningPoint1': 'OTP, NRIC எண்கள், கடவுச்சொற்கள், Singpass விவரங்கள் மற்றும் அட்டை எண்களை வெட்டவும்.',
  'analyze.privacy.imageWarningPoint2': 'தனிப்பட்ட தகவல்கள் உள்ள ஊடகத்தைப் பதிவேற்றாதீர்கள்.',
  'analyze.privacy.audioVideoWarningPoint1': 'OTP, NRIC எண்கள், கடவுச்சொற்கள், Singpass விவரங்கள் அல்லது அட்டை எண்களைப் பதிவேற்றாதீர்கள்.',
  'analyze.privacy.audioVideoWarningPoint2': 'தனிப்பட்ட தகவல்கள் அகற்றப்பட்ட பதிப்பைப் பயன்படுத்தவும்.',
  'analyze.privacy.body':
  ...
  'report.comfort': 'மோசடியை பார்த்தீர்களா அல்லது அனுபவித்தீர்களா?',
  'report.supporting': 'உங்கள் புகார் மற்றவர்களை எச்சரிக்கும்.',
  ...
  'community.participant': 'பங்கேற்பாளர் {id}',
