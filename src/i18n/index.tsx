...
const en = {
  ...
  'home.tip':
    'Tip: You can analyze a suspicious message, phone call, or video. Nothing you upload is shared publicly — results are for your awareness.',
...
const zh: Dict = {
  ...
  'home.tip':
    '提示：您可以分析可疑的信息、来电或视频。您上传的内容不会公开分享，分析结果仅供您参考。',

  'analyze.startAnalyzing': '点击开始分析',
  'analyze.startRecording': '点击开始／停止录音',
  'analyze.stopRecording': '停止录音',
  'analyze.transcribed': '转写文字（可编辑）：',
  'analyze.transcribing': '正在转写…',
  'analyze.result': '分析结果',
  'analyze.probability': '诈骗概率',
  'analyze.maxDuration': '最长 5 分钟',
  'analyze.why': '原因',
...
const ms: Dict = {
  ...
  'home.tip':
    'Tip: Anda boleh menganalisis mesej, panggilan telefon atau video yang mencurigakan. Apa yang anda muat naik tidak dikongsi secara umum — keputusan adalah untuk kesedaran anda sendiri.',

  'analyze.startAnalyzing': 'Klik untuk mula analisis',
  'analyze.startRecording': 'Klik untuk mula/henti rakaman suara',
  ...
  'analyze.maxDuration': 'tempoh maksimum 5 minit',
  'analyze.why': 'Sebab',
...
const ta: Dict = {
  ...
  'home.tip':
    'குறிப்பு: சந்தேகத்திற்குரிய செய்தி, தொலைபேசி அழைப்பு அல்லது வீடியோவை பகுப்பாய்வு செய்யலாம். நீங்கள் பதிவேற்றுவது பொதுவில் பங்கிடப்படாது — முடிவுகள் உங்கள் விழிப்புணர்வுக்கு மட்டுமே.',

  'analyze.startAnalyzing': 'பகுப்பாய்வைத் தொடங்க',
  'analyze.startRecording': 'குரல் பதிவைத் தொடங்க／நிற்க அழுத்தவும்',
  ...
  'analyze.maxDuration': 'அதிகபட்ச நீளம் 5 நிமிடங்கள்',
  'analyze.why': 'காரணம்',
